# Speech Rehab — 뇌경색 후 말하기 재활 보조 앱

> 뇌경색 이후 마비성 발음장애 환자의 자가 말하기 연습을 돕는 재활 보조 앱

---

## 📌 프로젝트 개요

Speech Rehab은 **뇌경색 이후 마비성 발음장애가 있는 사용자**가 집에서도 짧고 꾸준하게 말하기 연습을 할 수 있도록 돕는 앱입니다.  
음성 기반 대화, 소리 내어 읽기, 녹음 재생, 피로도/목표 기록, 연습 히스토리를 통해 환자와 보호자가 변화 과정을 확인할 수 있게 설계합니다.

> 이 앱은 진단이나 치료를 대체하지 않는 재활 보조 도구입니다. 연습 계획은 언어재활사 또는 의료진과 상의해 조정하는 것을 권장합니다.

### 핵심 특징

- 🏁 **히스토리 우선 진입** — 앱 실행 시 지난 대화 내역이 먼저 표시되어 학습 흐름을 바로 파악 가능
- 🧭 **재활 온보딩** — 최초 실행 시 안전 고지, 발병 후 기간, 연습 목표, 피로도 기준을 설정
- 🎙 **순수 음성 인터페이스** — 텍스트 입력창 없이 오직 음성으로만 대화하는 몰입형 환경
- 📖 **소리 내어 읽기 연습** — 정해진 문장이나 자유 발화를 통해 발음을 교정받는 전용 훈련 모드
- 🧑‍⚕️ **재활 세션 기록** — 오늘 목표, 시작 전 피로도, 녹음 시간, 피드백을 함께 저장
...
│   │   ├── provider/
│   │   └── view/
│   ├── onboarding/                              # 재활 안전 고지 및 초기 목표 설정
...
└── services/
    ...
    └── rehab_profile_service.dart               # 재활 프로필/온보딩 저장소
```
...
### 0. 뇌경색 후 마비성 발음장애 재활 목적 반영
- 최초 실행 시 안전 고지와 재활 목표 설정을 확인하는 온보딩을 추가했습니다.
